  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Duplicate button — bottom-left when selected */}
        <div
          data-handle
          onPointerDown={(e) => { e.stopPropagation(); e.preventDefault(); onDuplicate(sticker.id) }}
          className="absolute -left-5.5 -bottom-5.5 flex h-10 w-10 items-center justify-center cursor-pointer"
          style={{
            opacity: isSelected ? 1 : 0,
            pointerEvents: isSelected ? "auto" : "none",
            zIndex: 1,
