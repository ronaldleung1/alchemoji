  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        className="outline-hidden placeholder:text-muted-foreground flex h-10 w-full bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
